...
#else
  // Optimize for resize. 
  #define res (iResolution.xy/1.0) // change the 1.0 to 2.0 or higher to change resolution
#endif
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ){
  ...
  //uncomment the next line if you want to warp your screen corners. 
  //You should reduce resolution as well (/2 on line 33)
  //this will severely reduce your framerate as well...
